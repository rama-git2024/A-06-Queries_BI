SELECT
	...
	CAST (MAX(CASE WHEN c.F01132 = 'AF 0.5 - Impedimento Cobrança / Jurídico' THEN a.F00385 ELSE NULL END) AS DATE) AS 'AF 0.5',
	...
	CAST (MAX(CASE WHEN c.F01132 = 'AF 3.2.3. - Calculadora de consolidação negada' THEN a.F00385 ELSE NULL END) AS DATE) AS 'AF 3.2.2',
	...
	CAST (MAX(CASE WHEN c.F01132 = 'AF 12.8 - Inviabilidade de Consolidação (Calculadora Negativa)' THEN a.F00385 ELSE NULL END) AS DATE) AS 'AF 12.8',
	CAST (MAX(CASE WHEN c.F01132 = 'AF 12.9 - Ônus na matrícula' THEN a.F00385 ELSE NULL END) AS DATE) AS 'AF 12.9',
    DATEDIFF(DAY,
